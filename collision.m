...
% Collision checking between a 1DOF robot and a sphere
        function Part1()
            ...
            hold on;
            PlaceObject('lightcurtainv2.ply',[-104,-5,3]), trotz(pi/2)
            % place holder, can implement a single line plane to be used as
            % a safety mechanicsm, once it crosses a threshold (the plane
            % OR SPHERE, it will stop) 
