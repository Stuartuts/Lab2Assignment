classdef ZU3 < handle
    ...
    methods
        ...
        function SetZU3(self)
            L(1) = Link('d',0.1506,'a',0.0,'alpha',deg2rad(90),'offset',0,'qlim',[deg2rad(-270) deg2rad(270)]);
            L(2) = Link('d',-0.1150,'a',-0.4,'alpha',0,'offset',0,'qlim',[deg2rad(-85) deg2rad(265)]);
            ...
            q = [deg2rad(-90) deg2rad(-90) 0 deg2rad(90) 0 0];
            self.model.teach(q);
        end
