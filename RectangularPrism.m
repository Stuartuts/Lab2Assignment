function [vertex,face,faceNormals] = RectangularPrism(lower,upper,plotOptions,axis_h) %From UTS Industrial Robotics Lab 5 exercise https://canvas.uts.edu.au/courses/27375/pages/lab-5-exercises/
if nargin<4
        axis_h=gca;
    if nargin<3
...
face=[1,2,3;1,3,7;
     ...
     3,7,5;3,8,5;
     6,5,8;6,4,8];
patch('Faces',face,'Vertices',vertex,'FaceVertexCData',[1,1,204/255],'FaceColor','flat','lineStyle','none');
if 2 < nargout    
